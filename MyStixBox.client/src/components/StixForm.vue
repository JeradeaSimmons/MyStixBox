...
<slot name="button">
  ...
  <template #header> <h2 class="text-black">Add Stix</h2></template>
  <template #body>
    <form class="row p-5" @submit.prevent="handleSubmit">
      ...
      <div class="col-md-4 mb-3">
        ...
        <input required v-model="editable.company" type="text" class="form-control" name="stix-company"
          id="stix-company" placeholder="Company">
      </div>
      <div class="col-md-4 mb-3">
      ...
      <div class="col-md-4 mb-3">
        ...
        <input required v-model="editable.wrapper" type="text" class="form-control" name="stix-wrapper"
          id="stix-wrapper" placeholder="Wrapper">
      </div>
      <div class="col-md-4 mb-3">
      ...
      <div class="col-12 mb-3">
        <label for="stix-myReview" class="form-label">Review</label>
        <textarea v-model="editable.myReview" class="form-control" name="stix-myReview" id="stix-myReview"
          rows="3"></textarea>
      </div>
      <div class="col-12">
        <button class="btn btn-secondary" data-bs-dismiss="modal" title="submit form">Create <i
